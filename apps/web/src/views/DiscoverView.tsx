    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="lg:col-span-6 p-12 lg:p-16 space-y-8">
          ...
          <div className="flex flex-wrap gap-3">
            {dashboard.templates.map((template) => (
              <button
                key={template.id}
                className="focus-ring rounded-full border border-outline-variant/10 bg-surface-container-high px-4 py-2 font-label text-[10px] font-bold uppercase tracking-widest text-on-surface-variant transition-all hover:bg-surface-container-highest hover:text-on-surface"
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button
              className="focus-ring flex items-center gap-2 rounded-xl bg-primary px-8 py-3.5 font-label text-xs font-bold uppercase tracking-widest text-on-primary shadow-lg transition-all hover:scale-[1.02] active:scale-95"
            ...
            <button
              className="focus-ring flex items-center gap-2 rounded-xl border border-outline-variant/20 bg-surface px-8 py-3.5 font-label text-xs font-bold uppercase tracking-widest text-on-surface transition-all hover:bg-surface-container-low"
      ...
      <section className="space-y-8 pb-12">
        <div className="flex justify-between items-end">
          ...
          <button
            className="focus-ring font-label text-[10px] font-bold uppercase tracking-widest text-primary hover:underline"
            onClick={onOpenLibrary}
            type="button"
          >
          ...
          {dashboard.templates.slice(0, 3).map((template) => (
            ...
            >
              ...
              <div className="p-8 space-y-4 flex-1 flex flex-col">
                ...
                <button
                  className="focus-ring w-full mt-4 py-3 rounded-xl border border-outline-variant/20 font-label text-[10px] font-bold uppercase tracking-widest hover:bg-primary hover:text-on-primary hover:border-primary transition-all"
                  onClick={() => onApplyTemplate(template.id)}
                  type="button"
                >
